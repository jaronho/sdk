...
/**
 * @brief 收集结束回调
 * @param filename 崩溃堆栈日志文件名(文件名自动生成)
 */
...
public:
     ...
     */
    static void open(const std::string& dumpFilePath, const std::string& fullProcName, const FinishCallback& callback);
...
private:
    ...
    static std::string m_fullProcName; /* 当前程序名 */
