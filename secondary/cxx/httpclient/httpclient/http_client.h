...
public:
    ...
    /**
     * @brief 创建带证书文件请求对象
     * @param sslCaFilename 证书文件名
     * @param url 资源地址
     * @return 请求对象
     */
    static curlex::CafileRequestPtr makeCafileRequest(const std::string& sslCaFilename, const std::string& url);
     ...
     * @return 数据对象
     */
    static curlex::RawRequestDataPtr makeRawData(const unsigned char* bytes, size_t count);
     ...
     * @return 数据对象
     */
    static curlex::FormRequestDataPtr makeFormData(const std::string& data);
