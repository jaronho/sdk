...
public class WrapRecyclerView extends RecyclerView {
    ...
    private void addHeaderView() {
        WrapRecyclerViewAdapter adapter = (WrapRecyclerViewAdapter)getAdapter();
        if (null != adapter && null != mHeadCreator && null == mHeadView) {
            View headView = mHeadCreator.getView(getContext(), this);
            if (null != headView) {
                adapter.addHeaderView(KEY_HEAD_VIEW, headView);
                mHeadView = headView;
            }
        }
    }
    ...
    private void addFooterView() {
        ...
        if (null != adapter && null != mFootCreator && null == mFootView) {
            ...
            if (null != footView) {
                adapter.addFooterView(KEY_FOOT_VIEW, footView);
                mFootView = footView;
            }
        }
    }
    ...
    public static abstract class Creator {
        // 获取刷新视图
        public abstract View getView(Context context, WrapRecyclerView parent);
