...
void md5_update(md5_ctx_t* context, const unsigned char* input, unsigned int inputLen) {
...
void md5_fini(md5_ctx_t* context, unsigned char digest[16]) {
...
const char* md5_sign(const unsigned char* input, unsigned int inputLen) {
    ...
    md5_fini(&md5, (unsigned char*)hash);
