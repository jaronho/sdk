...
private:
    ...
    std::atomic<int64_t> m_lastRecvTime = {0}; /* 最近接收数据时间, 系统启动至今的耗秒数 */
    std::atomic<int64_t> m_lastSendTime = {0}; /* 最近发送数据时间, 系统启动至今的耗秒数 */
    std::atomic<int64_t> m_lastSendHeartbeatTime = {0}; /* 最近发送心跳的时间, 系统启动至今的耗秒数 */
