...
{
    printf("\n");
    bool bigEndium = utilitiy::ByteArray::isBigEndium();
    if (bigEndium)
    {
    ...
    long long l_2 = utilitiy::ByteArray::swab64(l_1);
    printf("--- l_2(%s): 0x%016llx\n", bigEndium ? "Little" : "   Big", l_2);
    long long l_3 = utilitiy::ByteArray::swab64(l_2);
    ...
    printf("\n");
    long long b_2 = utilitiy::ByteArray::swab64(b_1);
