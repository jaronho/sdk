...
public:
     ...
     * @return 字符串, 例如: "12:32"
     */
    std::string hhmm(const char sep1[1] = ":") const;
     ...
     * @param sep2 分隔符(选填), 例如: " "
     * @param sep3 分隔符(选填), 例如: ":"
     * @return 字符串, 例如: "2022-12-03 12:32"
     */
    std::string yyyyMMddhhmm(const char sep1[1] = "-", const char sep2[1] = " ", const char sep3[1] = ":") const;
