...
public:
     ...
     * @return 二进制字符串
     */
    static std::string dec2bin(unsigned long long dec, unsigned int bit = 0);
     ...
     * @return 十进制数字
     */
    static unsigned long long bin2dec(const std::string& binStr);
     ...
     * @return 十六进制字符串
     */
    static std::string dec2hex(unsigned long long dec, unsigned int bit = 0, bool prefix = false, bool isUpper = true);
